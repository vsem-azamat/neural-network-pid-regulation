...
and finally print the summary tables (comparisons.summary) the README quotes.
...
def main() -> None:
    ...
    # The tables the README quotes, from whatever results/ now holds.
    subprocess.run([sys.executable, "-m", "comparisons.summary"])
