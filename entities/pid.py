...
class PID:
	...
	def compute(
		...
		error: Tensor, 
		dt: Tensor,
		method: Literal['standard', 'backward_euler', 'trapezoidal', 'forward_euler', 'bilinear_transform'] = 'standard'
		) -> Tensor:
		...
		match method:
			...
			case _:
				raise ValueError("Invalid method. Choose between 'standard', 'backward_euler', 'trapezoidal', 'forward_euler', 'bilinear_transform'")
