...
def compare_predictions(model, msd: SpringDamper, num_steps=200):
    ...
    for control in control_inputs:
        ...
        with torch.no_grad():
            rbf_input = torch.tensor([[msd.X.item(), msd.dXdT.item(), msd.d2XdT2.item(), control.item()]])
...
if __name__ == "__main__":
    ...
    # Compare predictions
    control_inputs, rbf_positions, actual_positions = compare_predictions(rbf_model, msd)
